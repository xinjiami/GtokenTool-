...
实操流程（配置与执行）：提供从钱包授权、参数预设到策略启动的全流程图文教程，指导用户如何针对 Letsbonk 进行精准的买入、卖出或流动性维护操作。
...
自动选择DEX：清楚DEX时，可以自己手动选择DEX。不清楚DEX时，可以开启这个选项。若手动选择DEX交易不成功，请切换到自动选择DEX再次交易。（这里我们选择 Bonk）
